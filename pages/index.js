      ...
      <main>
        <div className="relative pt-16 pb-32 flex content-center items-center justify-center min-h-screen-75">
          <div
            ...
            style={{
              backgroundImage:
                "url('https://source.unsplash.com/qYreP9QOdrk/1600x900')",
            }}
          >
            <span
              id="blackOverlay"
            ...
            <div className="flex flex-wrap items-center mt-32">
              <div className="w-full md:w-5/12 px-4 mr-auto ml-auto">
                ...
                <MobileStoreButton
                  store="android"
                  url={
                    "https://play.google.com/store/apps/details?id=com.appbakeryworld.app"
                  }
              ...
              <div className="w-full md:w-4/12 px-4 mr-auto ml-auto">
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full md:mb-24 mb-12 shadow-lg rounded-lg bg-blueGray-700">
